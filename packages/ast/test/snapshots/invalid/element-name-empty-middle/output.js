      ...
      subElements: [
        ...
        },
        {
          ...
          textContents: [
            {
              type: "XMLTextContent",
              position: { startOffset: 44 },
              text: "john"
            }
          ],
          position: { startOffset: 38 },
          syntax: {
            openName: { image: "from", startOffset: 39 },
            closeName: { image: "from", startOffset: 50 }
          }
        }
      ],
      textContents: [
        ...
        { type: "XMLTextContent", position: { startOffset: 55 }, text: "\r\n" }
      ],
